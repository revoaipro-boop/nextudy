...
export async function GET(request: Request) {
  try {
    ...
    const now = new Date()
    console.log(`[v0] Morning reminder (8h) at ${now.toISOString()}`)
    ...
    for (const profile of profiles) {
      ...
      try {
        await transporter.sendMail({
          ...
          to: user.email,
          subject: "☀️ Bonjour ! C'est l'heure de ta révision matinale",
          html: `
            <!DOCTYPE html>
            <html>
              <head>
              ...
              <body>
                <div class="container">
                  ...
                  <div class="content">
                    <p>Commence ta journée du bon pied avec une session de révision ! 📚</p>
                    <p>Le matin est le moment idéal pour apprendre de nouvelles choses.</p>
                    ...
                    <p style="margin-top: 30px; font-size: 14px; color: #666;">
                      💡 <strong>Astuce :</strong> Réviser le matin améliore la concentration et la mémorisation !
                    </p>
                  </div>
                  <div class="footer">
    ...
    console.error("[v0] Error in morning reminder:", error)
